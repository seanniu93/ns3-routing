#ifndef DVTABLEMSG_H_
#define DVTABLEMSG_H_
 ...
 */
class DVTableMessage : public SimpleRefCount<DVTableMessage>
{
  public:
    DVTableMessage (uint32_t sequenceNumber, Time timestamp, std::vector<Ipv4Address> neighbors);
    ~DVTableMessage ();
